...
public class Practica01JUnit5 {
	...
	public void testDevicesSendMessagesRemove() {
 		...
 		assertFalse(d1.substitute("amigo", null)); //borramos la palabra amigo
 		assertFalse(d1.substitute(null, "que")); //borramos la palabra que
 		assertFalse(d1.substitute("tal", null)); //borramos la palabra tal
